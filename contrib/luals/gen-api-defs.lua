...
--
--   lua gen-api-defs.lua ./scripting-interface.txt \
--       > contrib/luals/pxapi-addon/library/ptokax-api.lua
--
...
local function typeof(name)
	...
	if CLASS_PARAM[name] then
		return CLASS_PARAM[name]
	end
...
local function params(argstr)
	local out = {}
	if not argstr or argstr:match("^%s*$") then
		return out
	end
...
local RETURNS = {
	...
	["Core.GetActualUsersPeak"] = "integer",
	["Core.GetMaxUsersPeak"] = "integer",
	["Core.GetCurrentSharedSize"] = "integer",
	["Core.GetUsersCount"] = "integer",
	["Core.GetUpTime"] = "integer",
	["Core.GetHubIP"] = "string?",
	["Core.GetHubIPs"] = "string[]?",
	["Core.GetHubSecAlias"] = "string",
	["Core.GetPtokaXPath"] = "string",
	["Core.GetOnlineNonOps"] = "User[]",
	["Core.GetOnlineOps"] = "User[]",
	["Core.GetOnlineRegs"] = "User[]",
	["Core.GetOnlineUsers"] = "User[]",
	["Core.GetUser"] = "User?",
	["Core.GetUsers"] = "User[]?",
	["Core.GetUserValue"] = "any",
	["Core.GetUserAllData"] = "boolean?",
	["Core.GetUserData"] = "boolean?",
	["Core.SetUserInfo"] = "boolean?",

	["SetMan.GetMOTD"] = "string?",
	["SetMan.GetBool"] = "boolean?",
	["SetMan.GetNumber"] = "integer?",
	["SetMan.GetString"] = "string?",
	["SetMan.GetMinShare"] = "integer",
	["SetMan.GetMaxShare"] = "integer",
	["SetMan.GetOpChat"] = "OpChatInfo",
	["SetMan.GetHubBot"] = "HubBotInfo",

	["RegMan.GetRegsByProfile"] = "RegisteredUser[]",
	["RegMan.GetNonOps"] = "RegisteredUser[]",
	["RegMan.GetOps"] = "RegisteredUser[]",
	["RegMan.GetRegs"] = "RegisteredUser[]",
	["RegMan.GetReg"] = "RegisteredUser?",

	["BanMan.GetBans"] = "Ban[]",
	["BanMan.GetTempBans"] = "Ban[]",
	["BanMan.GetPermBans"] = "Ban[]",
	["BanMan.GetBan"] = "Ban|Ban[]|nil",
	["BanMan.GetPermBan"] = "Ban|Ban[]|nil",
	["BanMan.GetTempBan"] = "Ban|Ban[]|nil",
	["BanMan.GetRangeBans"] = "RangeBan[]",
	["BanMan.GetTempRangeBans"] = "RangeBan[]",
	["BanMan.GetPermRangeBans"] = "RangeBan[]",
	["BanMan.GetRangeBan"] = "RangeBan?",
	["BanMan.GetRangePermBan"] = "RangeBan?",
	["BanMan.GetRangeTempBan"] = "RangeBan?",

	["ProfMan.AddProfile"] = "integer?",
	["ProfMan.GetProfile"] = "Profile?",
	...
	["ScriptMan.GetScript"] = "ScriptInfo",
	["ScriptMan.GetScripts"] = "ScriptInfo[]",

	["IP2Country.GetCountryCode"] = "string?",
	["IP2Country.GetCountryName"] = "string?",
}

local function returns(desc)
	local d = desc:lower()
	if
		d:match("return nil when failed")
		or d:match("return true")
		or d:match("true if success")
		or d:match("true when success")
	then
		return "boolean?"
...
while i <= #lines do
	...
	elseif kind == "class" and section then
		...
		if f then
			local t = typeof(f)
			if d:lower():match("or nil") or d:lower():match("^true or nil") then
				t = t .. "?"
			end
